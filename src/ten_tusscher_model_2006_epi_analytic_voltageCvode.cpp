...
const double V_ss = 5.468e-05;
    ...
    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }

void Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode::SetIntegrationConstant(double voltage){
...
double Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode::CalculateAnalyticVoltage(){
  ...
  return V;
    ...
    Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode::Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                18,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode::~Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode()
    {
    }
    
    void Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode::VerifyStateVariables()
    {
    ...
    double Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
      double var_chaste_interface__membrane__V = CalculateAnalyticVoltage(); //(mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellten_tusscher_model_2006_epi_analytic_voltageFromCellMLCvode)
#endif // CHASTE_CVODE
