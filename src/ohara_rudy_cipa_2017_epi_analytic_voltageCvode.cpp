...
//!
//! Model: ohara_rudy_cipa_v1_2017_analytic_voltage
//!
//! Processed by chaste_codegen: https://github.com/ModellingWebLab/chaste-codegen
//!     (translator: chaste_codegen, model type: NumericCvode)
//! on 2021-03-23 23:58:29
//!
//! <autogenerated>
...
static double CalculateAnalyticVoltage(const N_Vector& rY, const N_Vector& mParameters){
       ...
       const double var_intracellular_ions__trpnmax = 0.070000000000000007; // millimolar
        ...
        const double var_membrane__sum_ext_charges = 2.0 * NV_Ith_S(mParameters, 9) + NV_Ith_S(mParameters, 10) + NV_Ith_S(mParameters, 11); // millimolar
        const double var_membrane__C0 = NV_Ith_S(mParameters, 6) + var_membrane__sum_ext_charges; // millimolar
       const double var_physical_constants__F = 96485.0; // coulomb_per_mole
        const double var_membrane__potential = (2.0 * var_intracellular_ions__cai_tot + (2.0 * var_intracellular_ions__cass_tot + var_chaste_interface__intracellular_ions__kss + var_chaste_interface__intracellular_ions__nass) * var_cell_geometry__vss / var_cell_geometry__vmyo + 2.0 * var_cell_geometry__vjsr * var_intracellular_ions__cajsr_tot / var_cell_geometry__vmyo + 2.0 * var_cell_geometry__vnsr * var_chaste_interface__intracellular_ions__cansr / var_cell_geometry__vmyo + var_chaste_interface__intracellular_ions__ki + var_chaste_interface__intracellular_ions__nai) * var_cell_geometry__vmyo * var_physical_constants__F / (var_cell_geometry__Acap * var_intracellular_ions__cm); // millivolt
        const double var_membrane__V2 = -var_cell_geometry__vmyo * var_membrane__C0 * var_physical_constants__F / (var_cell_geometry__Acap * var_intracellular_ions__cm) + var_membrane__potential; // millivolt

        return var_membrane__V2;
}

    boost::shared_ptr<RegularStimulus> Cellohara_rudy_cipa_2017_epi_analytic_voltageFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_cipa_2017_epi_analytic_voltageFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
                ...
                pIntracellularStimulus)
    {
        // Time units: millisecond
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_cipa_2017_epi_analytic_voltageFromCellMLCvode>::Instance();
        Init();

        // We have a default stimulus specified in the CellML file metadata
        this->mHasDefaultStimulusFromCellML = true;

        NV_Ith_S(this->mParameters, 0) = 0; // (var_IKr__Kmax) [dimensionless]
        NV_Ith_S(this->mParameters, 1) = 0; // (var_IKr__Kt) [per_millisecond]
        NV_Ith_S(this->mParameters, 2) = 0; // (var_IKr__Ku) [per_millisecond]
        NV_Ith_S(this->mParameters, 3) = 1.0; // (var_IKr__Vhalf) [millivolt]
        NV_Ith_S(this->mParameters, 4) = 1.0; // (var_IKr__halfmax) [dimensionless]
        NV_Ith_S(this->mParameters, 5) = 1.0; // (var_IKr__n) [dimensionless]
        NV_Ith_S(this->mParameters, 6) = 7.8011181799623701; // (var_membrane__Gamma0) [millimolar]
    ...
    Cellohara_rudy_cipa_2017_epi_analytic_voltageFromCellMLCvode::~Cellohara_rudy_cipa_2017_epi_analytic_voltageFromCellMLCvode()
    {
    }


    double Cellohara_rudy_cipa_2017_epi_analytic_voltageFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellohara_rudy_cipa_2017_epi_analytic_voltageFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__intracellular_ions__cai = NV_Ith_S(rY, 0);
        ...
        // Units: dimensionless; Initial value: 0.0
        double var_chaste_interface__IKr__D = NV_Ith_S(rY, 42);
        // Units: dimensionless; Initial value: 0.0
        double var_chaste_interface__IKs__xs1 = NV_Ith_S(rY, 43);
        // Units: dimensionless; Initial value: 0.2707758025
        double var_chaste_interface__IKs__xs2 = NV_Ith_S(rY, 44);
        ...
        const double d_dt_chaste_interface_var_IKr__D = 0; // 1 / millisecond
        const double var_ICaL__Aff = 0.59999999999999998; // dimensionless
        const double var_ICaL__Afs = 1.0 - var_ICaL__Aff; // dimensionless
        ...
        NV_Ith_S(rDY,42) = d_dt_chaste_interface_var_IKr__D;
    ...
    N_Vector Cellohara_rudy_cipa_2017_epi_analytic_voltageFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__intracellular_ions__cai = NV_Ith_S(rY, 0);
        ...
        NV_Ith_S(dqs, 3) = var_ICaL__ICaK_converted;
        NV_Ith_S(dqs, 4) = var_ICaL__ICaNa_converted;
        NV_Ith_S(dqs, 5) = var_ICaL__ICaL_converted;
        NV_Ith_S(dqs, 6) = var_ICab__ICab_converted;
        NV_Ith_S(dqs, 7) = var_IKb__IKb_converted;
        NV_Ith_S(dqs, 8) = var_INab__INab_converted;
        NV_Ith_S(dqs, 9) = var_IpCa__IpCa_converted;
        NV_Ith_S(dqs, 10) = var_INa__INa_converted;
        NV_Ith_S(dqs, 11) = var_INa__h;
        ...
        NV_Ith_S(dqs, 16) = var_INaCa_i__INaCa_i_converted;
        NV_Ith_S(dqs, 17) = var_INaCa_i__INaCa_ss_converted;
        NV_Ith_S(dqs, 18) = var_INaK__INaK_converted;
        NV_Ith_S(dqs, 19) = var_membrane__Istim_converted;
...
{
    this->mSystemName = "ohara_rudy_cipa_v1_2017_analytic_voltage";
...
CHASTE_CLASS_EXPORT(Cellohara_rudy_cipa_2017_epi_analytic_voltageFromCellMLCvode)
