...
double ohara_rudy_cipa_v1_2017FromCellMLCvode::calculateAnalyticVoltage(){
  const std::vector<double> state_vars = GetStdVecStateVariables();
  ...
  const double voltage = state_vars[0];
  ...
  return analytic_voltage;
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 1) = 0; // (var_IKr__D) [dimensionless]
        NV_Ith_S(this->mParameters, 2) = 0; // (var_IKr__Kmax) [dimensionless]
        NV_Ith_S(this->mParameters, 3) = 0; // (var_IKr__Kt) [per_millisecond]
        NV_Ith_S(this->mParameters, 4) = 0; // (var_IKr__Ku) [per_millisecond]
        NV_Ith_S(this->mParameters, 5) = 1.0; // (var_IKr__Vhalf) [millivolt]
        NV_Ith_S(this->mParameters, 6) = 1.0; // (var_IKr__halfmax) [dimensionless]
        NV_Ith_S(this->mParameters, 7) = 1.0; // (var_IKr__n) [dimensionless]
        NV_Ith_S(this->mParameters, 8) = 1.0; // (var_ryr__Jrel_scaling_factor) [dimensionless]
        NV_Ith_S(this->mParameters, 9) = 1.0; // (var_SERCA__Jup_b) [dimensionless]
        NV_Ith_S(this->mParameters, 10)= 1.8; // (var_extracellular__cao) [millimolar]
        NV_Ith_S(this->mParameters, 11) = 5.4000000000000004; // (var_extracellular__ko) [millimolar]
        NV_Ith_S(this->mParameters, 12) = 140.0; // (var_extracellular__nao) [millimolar]
        NV_Ith_S(this->mParameters, 13) = 0.00010069999999999999; // (var_ICaL__PCa_b) [dimensionless]
        NV_Ith_S(this->mParameters, 14) = 2.4999999999999999e-8; // (var_ICab__PCab) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 15) = 0.0030000000000000001; // (var_IKb__GKb_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 16) = 3.75e-10; // (var_INab__PNab) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 17) = 0.00050000000000000001; // (var_IpCa__GpCa) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 18) = 75.0; // (var_INa__GNa) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 19) = 0.32397839999999978; // (var_IK1__GK1_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 20) = 0.019957499999999975; // (var_INaL__GNaL_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 21) = 0.046585454545454562; // (var_IKr__GKr_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 22) = 0.0063580000000000008; // (var_IKs__GKs_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 23) = 0.00080000000000000004; // (var_INaCa_i__Gncx_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 24) = 30.0; // (var_INaK__Pnak_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 25) = 0.02; // (var_Ito__Gto_b) [milliS_per_microF]
    }
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        // Units: dimensionless; Initial value: 0.0027494140442
    ...
    void Cellohara_rudy_cipa_v1_2017FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = calculateAnalyticVoltage(GetStdVecStateVariables());
        // Units: millivolt; Initial value: -88.00190465
        double var_chaste_interface__intracellular_ions__cai = NV_Ith_S(rY, 0);
        // Units: millimolar; Initial value: 8.6e-05
        double var_chaste_interface__CaMK__CaMKt = NV_Ith_S(rY, 1);
    ...
    void Cellohara_rudy_cipa_v1_2017FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        double var_chaste_interface__IKr__IObound = NV_Ith_S(rY, 39);
        // Units: dimensionless; Initial value: 0.0
        double var_chaste_interface__IKr__Cbound = NV_Ith_S(rY, 40);
        // Units: dimensionless; Initial value: 0.0
