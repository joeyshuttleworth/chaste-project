...
static double CalculateAnalyticVoltage(const N_Vector& rY, const N_Vector& mParameters){
  ...
  double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai = NV_Ith_S(rY, 0);
        ...
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CMDNtot = 0.050000000000000003; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CSQNtot = 15.0; // mM
        ...
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__EGTAtot = 0; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__F = 96485.0; // coulomb_per_mole
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__HTRPNtot = 0.14000000000000001; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__KmCMDN = 0.0023800000000000002; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__KmCSQN = 0.80000000000000004; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cajsr_tot = (1.0 + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CSQNtot / (var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__KmCSQN)) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__KmEGTA = 0.00014999999999999999; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cass_tot = (1.0 + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CMDNtot / (var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__KmCMDN) + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__EGTAtot / (var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__KmEGTA)) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ko = 4.0; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__LTRPNtot = 0.070000000000000007; // mM
        ...
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__sum_extracellular_charges = 2.0 * var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cao + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ko + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nao; // mM
        ...
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai_tot = (1.0 + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CMDNtot / (var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__KmCMDN) + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__EGTAtot / (var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__KmEGTA)) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__HTRPNtot * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__LTRPNtot * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa; // mM
        ...
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V2 = -var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__C0 * var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__F * var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Vmyo / (var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Acap * var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cm) + var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__potential; // mV
        return var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V2;
}

    boost::shared_ptr<RegularStimulus> Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
            return NV_Ith_S(mStateVariables, 0);
    }

    Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode::Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                66,
                99999,
                pIntracellularStimulus)
    {
        // Time units: millisecond
        //
        this->mpSystemInfo = OdeSystemInformation<Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode>::Instance();
        Init();

        // We have a default stimulus specified in the CellML file metadata
        this->mHasDefaultStimulusFromCellML = true;
        NV_Ith_S(this->mParameters, 0) = -10.2498652217866; // (var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Gamma0) [mM]
    }

    Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode::~Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode()
    {
    }

    double Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai = NV_Ith_S(rY, 0);
    ...
    N_Vector Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai = NV_Ith_S(rY, 0);
        ...
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ko = 4.0; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__LTRPNtot = 0.070000000000000007; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__M_capacitance = var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Acap * var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cm; // farad
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__M_capacitance_converted = 1000000.0 * var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__M_capacitance; // uF
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nao = 138.0; // mM
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__VJSR = 1.6e-7; // uL
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__VNSR = 2.0999999999999998e-6; // uL
        const double var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__VSS = 1.2e-9; // uL
        ...
        NV_Ith_S(dqs, 1) = var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V2;
        NV_Ith_S(dqs, 2) = var_chaste_interface__environment__time;
        NV_Ith_S(dqs, 3) = var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__M_capacitance_converted;
        NV_Ith_S(dqs, 4) = var_I_stimulus__i_Stim_converted;
        return dqs;
    }

template<>
void OdeSystemInformation<Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode>::Initialise(void)
{
    this->mSystemName = "iyer_2004_analytic_voltage";
    ...
    // NV_Ith_S(rY, 4):
    this->mVariableNames.push_back("COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES_CaJSR");
    this->mVariableUnits.push_back("mM");
    this->mInitialConditions.push_back(0.2852239446);

    // NV_Ith_S(rY, 5):
    this->mVariableNames.push_back("COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES_CaNSR");
    this->mVariableUnits.push_back("mM");
    ...
    this->mDerivedQuantityNames.push_back("analytic_voltage");
...
CHASTE_CLASS_EXPORT(Celliyer_mazhari_winslow_2004_analytic_voltageFromCellMLCvode)
